"""
Script Name: tracert.py
Author: Joshua Khokhar
Creation Date: 6/20/2023
Purpose: Retrieves the number and duration of hops encountered by the packet on its way to its destination specified by the user and writes it to a text file.
"""
