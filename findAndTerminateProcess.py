...
To terminate any process using this script, replace the "Notepad.exe" argument for the Name parameter with the process you would like to terminate and run the script.
"""
